export default {
  'pages.login.loginType.normal': 'Login dengan akun',
  'pages.login.normal.errorMessage': 'Nama pengguna dan kata sandi salah',
  ...
  'pages.login.loginType.sms': 'Login dengan ponsel',
  'pages.login.phone.errorMessage': 'Kesalahan kode verifikasi',
  ...
  'pages.login.phone.getVerificationCode': 'Dapatkan kode',
  'pages.login.getCaptchaSecondText': 'detik tersisa',
