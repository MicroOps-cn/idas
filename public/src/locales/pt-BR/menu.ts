export default {
  ...
  'menu.settings': 'Configuração do sistema',
  'menu.account.setting': 'Configuração do utilizador',
  'menu.account.events': 'Eventos do utilizador',
  'menu.account.loginout': 'Sair',
  'menu.events': 'Eventos',
  'menu.users': 'Utilizador',
  'menu.roles': 'Papel',
  'menu.apps': 'Aplicação',
};
